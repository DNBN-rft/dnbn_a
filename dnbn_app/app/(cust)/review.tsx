  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>리뷰관리</Text>
      ...
      <View style={styles.topnav}>
        ...
        >
          <Text
            style={[
              styles.topnavText,
              selectedTab === "unwritten" && styles.activeTabText,
            ]}
          >
            미작성 리뷰
          </Text>
        ...
        >
          <Text
            style={[
              styles.topnavText,
              selectedTab === "written" && styles.activeTabText,
            ]}
          >
            작성 리뷰
          </Text>
      ...
      {selectedTab === "written" ? (
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                ...
                {/* 이미지 + 정보 Row */}
                <View
                  style={[styles.writtenReviewRow, { alignItems: "center" }]}
                >
                  {item.productImages?.files?.[0]?.fileUrl ? (
                    <Image
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>작성할 리뷰가 없습니다</Text>
        </View>
      ) : (
        <FlatList
          style={{ flex: 1 }}
