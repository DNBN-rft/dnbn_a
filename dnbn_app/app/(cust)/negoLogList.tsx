...
export default function NegoLogListScreen() {
    ...
    const [editingItem, setEditingItem] = useState<CustNegoCurrentResponse | null>(null);
        ...
        <View style={styles.itemContainer}>
            <View style={styles.itemHeader}>
                <Text style={styles.itemDateTime}>
                    {new Date(item.requestDateTime).toLocaleDateString()} {new Date(item.requestDateTime).toLocaleTimeString()}
                </Text>
            </View>
    ...
    const renderCompleteItem = ({ item }: { item: CustNegoCompleteResponse }) => {
        ...
        return (
            <View style={styles.itemContainer}>
                <View style={styles.itemHeader}>
                    <Text style={styles.itemDateTime}>
                        응답일: {new Date(item.responseDateTime).toLocaleDateString()} {new Date(item.responseDateTime).toLocaleTimeString()}
                    </Text>
    ...
    const dataList =
        activeTab === "current" ? currentNegoList : completeNegoList;
            ...
            {loading ? (
                ...
                <View style={styles.emptyContainer}>
                    ...
                    <Text style={styles.emptyText}>
                        {activeTab === "current" ? "요청 내역이 없습니다" : "완료된 내역이 없습니다"}
                    </Text>
                </View>
            ) : (
                <FlatList
                    ...
                    renderItem={
                        (activeTab === "current" ? renderCurrentItem : renderCompleteItem) as any
                    }
